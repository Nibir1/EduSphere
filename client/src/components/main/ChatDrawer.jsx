...
import { Send, Bot, Loader2, MessageCircle, X } from "lucide-react";

// ⭐ IMPORT TOKEN HELPER TO ENSURE CONSISTENCY
...
export default function ChatDrawer() {
    ...
    const handleSend = async (e) => {
        ...
        const headers = {
            ...
            // ⭐ FIX: Use the shared token getter ensures we send the correct token
        ...
        // ⭐ FIX: Determine the correct API URL (Production vs Local)
        // If VITE_API_BASE_URL is set (Render), use it. Otherwise fallback to proxy "/api"
